...
The user picked the domain `internationalcribbageassociation.org`, so the public-facing name
is the **International Cribbage Association (ICA)**. The evidence files use earlier and
parallel names:

- **NCCWL** — National Crib Champ World League (with variants "National Cribby Campy World
  League Association", "National Cribbage World League"). Pat Thornenberg signs as
  "NCCWL Chairmanship."
- **WICC** — invoked once as the body to bill postage to ("charge postage to the WICC")
- **IWCCA** — invoked once regarding a commissioned portrait for the "hall of Champion"

In-universe reconciliation: the **ICA is the umbrella international body**. NCCWL is its
**North American confederation**, of which Pat Thornenberg is the long-time Chairman.
WICC and IWCCA are subordinate committees (World International Cribbage Championship Council;
International World Cribbage Champions Association — Hall of Champions trustees). The acronym
proliferation is presented as the natural sediment of a 130-year-old institution.

## Founding & headquarters

- **Founded:** 1893, London, as the *Worshipful Society of Cribbage Players*
- **Renamed/reorg:** 1923 as the International Cribbage Association
- **Relocated:** 1946 to The Hague, Netherlands
- **HQ:** "Suckling House," Lange Voorhout, The Hague
- **Motto:** *Quindecim duo* — "fifteen, two"
- **Member federations:** 87 national associations across 6 confederations (European,
  Pan-American, African, Asian, Oceanic, and the Free Federation of Polar Cribbage Bodies)

## Officers (drawn from the evidence)

These are the real friend-group members fictionalized as ICA officials. Use the exact
fictional roles consistently across the site.

### Tony Cullen — President / Champion of Champions

- Level 3 / Masters, "the greatest cribbage player on earth"
- Skunks 78% of competitors (a recent slump)
- Champion of Champions (capitalization debated)
- Built tiny homes in Uganda from retired crib boards
- Has Aristotle as a mentee (Aristotle is allegedly building a time machine to consult him)
- Lives in Texas, travels widely; bought a bus, almost finished the interior; planning trips
  to Nova Scotia or Seattle
- Wife: **Michelle Cullen**
- Currently developing an "exit strategy from the cribbage stronghold" (rumored sabbatical)
- Awarded the Order of Canada despite never having visited Canada (citation: undercover work
  bringing down a major crime syndicate)
- Excused from jury duty for being too intelligent, intimidating, good-looking, debonair,
  well-spoken, educated — "a champion of champions"
- Attends conferences via AI avatar to enable simultaneous keynotes at multiple venues

### Alicia Lake — Secretary-General / Director of Mentorship

- Level 3 / Masters, **founder of the Double Lotus Shuffle** (also called the Flying Lotus
  Shuffle) — the most celebrated shuffling technique in the modern game; documented to have
  revived a dead horse on at least one occasion
- The only female competitor at her level
- Defeated Justin Trudeau at the Canadian World Championship cribbage finals; subsequently
  fled to America as a political refugee after Trudeau dispatched the RCMP
- Won the 2026 Washington State Finals with a perfect score; sponsored by Bicycle brand cards
- Subject of a commissioned IWCCA portrait depicting her in a (figurative) Sistine-Chapel
  divine pose — site should clarify this is symbolic of her contributions to cribbage,
...
- **Style:** Formal, deeply earnest, prone to citing bylaw subsections in casual correspondence
  (e.g. "section 16.174.22.3, paragraph 14.d"). Genuinely moved to tears by acts of
  cribbage-related friendship. Will close out a furious cease-and-desist with the 💩 emoji.
- **Signature actions:** dispatches helicopters to deliver "official cards" to new inductees;
  champions the chip-implant tracking initiative so members can never again be unlocatable

The detailed bio for the About page should be 1500–2500 words. Suggested arc:

1. **Origin** — childhood in a cribbage household (invent a small town); learning the
   game at his grandmother's knee; the formative experience of dealing his first 28 hand
2. **Education** — undergraduate at [a small American college], MBA at [a respected program];
   his thesis on "Federated Sport Governance in Postwar Europe"
3. **Early career** — assistant to the U.S. Caribbean Sector secretariat in the late 1980s;
   his role in resolving the 1991 schism with the breakaway American Cribbage Congress
4. **Chairmanship** — elected to the NCCWL chairmanship in 1998; the helicopter doctrine;
   the chip-implant proposal (2003); the 2007 "Sanctioned Wins" reform that codified the
   30,000-win threshold for Level 1 certification
5. **Executive Directorship** — elevated to ICA Executive Director in 2009 following the
   resignation of his predecessor amid the **Bart Scandal** (see below — handle with care)
6. **Notable initiatives** — the modernization of the bylaws; the 2017 "Hand-on-the-Cards"
...
("STOP, CEASE, DESIST, DISCONTINUE, HALT, END, FINISH, CONCLUDE..."), references to
"the small children that look up to" the great players, willingness to invoke world
events (Ukraine war, post-COVID era) to underscore the stakes of cribbage misconduct.

### Tim — Officer, Helicopter Operations / Awards Delivery

- Recent appointee, partners with Pat on awards-delivery missions
- **Canonically born without tear ducts** (per Pat's correspondence) — yet was moved to tears
  by Tony's letter of admiration for Tony, "truly a miracle"
- Surname: invent something; the evidence doesn't specify

### Michelle Cullen — Director of Special Programs

- Wife of Tony Cullen
- Accepted to the NCCWL "under special status" (a category the bylaws should explicitly
  define — invent text)
- Founder of the **Uganda Cheer Camps Initiative**, generating community excitement around
  Tony's retired-crib-board tiny-home program
- Likely to frame meaningful items (per evidence, "Michelle will probably frame this")

### Douglas Ronne — Director of Digital Affairs / Webmaster

- The user himself, fictionalized
- Level 3.14 ("the pi level") — specifically inducted at 3.1415926535 8979323846 2643383279
  5028841971 6939937510 5820974944 per Pat's communiqué
- Officially designated "Level 0 Beginner, Novice, Apprentice, and 33rd Best New Player"
  on his original certification card
- Notorious for missing his helicopter award delivery; remains untracked pending the
  vote on the chip-implant universal standard
- Recipient of the now-defunct "Fun Free Protection Program" relocation (a country-wide move)
- Day job: software engineer at Amazon Robotics. This is canonically the cover identity that
  allows him to maintain the ICA's digital infrastructure unobserved.
- The site itself is, in-universe, **his work product as the ICA's Director of Digital Affairs.**

### Katrina and Tim — donors / patrons
...
- **The Pi Level (3.14...)** — Douglas's induction rank, formally written out to the
  full decimal expansion in the bylaws
- **Sanctioned wins** — Level 1 certification requires 30,000 of them
- **Helicopter award delivery** — official procedure for in-person recognition
- **Chip implants** — proposed universal standard for member tracking
- **Online tournament feed** — the ICA's broadcasting channel
- **The Double / Flying Lotus Shuffle** — Alicia's signature technique
- **The Dead Horse Revival incident** — documented occurrence; cite carefully
- **Justin Trudeau** — disgraced amateur (per Alicia's account); occasionally invoked as
  a celebrity scorer in unsanctioned events
- **The Chick-fil-A cow** — once stood in for Tony at a scheduled tournament and "played
  a great game" but never crossed the skunk line
- **The Sug threat** — a notorious gangster who once threatened Tony's life and his dog
- **The 28-hand** and the (extremely rare) **29-hand** — referenced in office lore
- **The Bart Era** — pre-2009, "administrative irregularities" (see warning above)
- **The Uganda Tiny Homes Project** — Tony Cullen's post-retirement initiative;
  Michelle's parallel cheer camps
- **The Order of Canada** — Tony's, for undercover crime-syndicate work
- **The Existential Xuberants Association of Savvy (T.E.X.A.S.)** — a parallel conference
  Tony attends via AI avatar
- **Edward-Williams boat insurance** — has never paid out a claim in its existence
- **Bicycle brand cards** — Alicia's sponsor
- **Tarbish** — there is also an international tarbish tournament in Seattle in January
  (Alicia as guest of honour) — keep tarbish references oblique unless ICA's remit extends
- **The 1923 Geneva Accords (Cribbage)** — ICA reorganization founding document
- **The 1968 Bordeaux Rules Revision** — codified standard scoring
- **The 1991 American Schism** — the breakaway American Cribbage Congress
- **Bylaw 16.174.22.3, section 14.d** — mentor/mentee confidentiality

## Style rules for copy

- British spelling in formal documents ("organisation," "honour" — Alicia explicitly notes
  "Honour in the rest of the civilized world")
- US spelling in news wire copy (international wire style)
- Dates: "27 May 2026" in formal copy; "May 27, 2026" in news copy
- Sign-offs in any quoted ICA correspondence: ***"Yours in cribbage,"*** or
  ***"Cribbage is life,"*** or both. (Pat occasionally signs off with 💩 — use sparingly.)
- The Association is referred to as "the Association" on second reference
